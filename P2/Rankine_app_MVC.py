...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.RC= rankineController(self.input_widgets, self.display_widgets) #NEW # instantiate a rankineController object and pass as arguments the two lists of widgets to be unpacked into the View
    ...
    def Calculate(self):
        self.RC.updateModel() #NEW #call the updateModel() method of the controller
        pass
    ...
    def setNewPLow(self):
        self.RC.setNewPLow() #NEW #??? call the setNewPLow() function of the controller
        pass
